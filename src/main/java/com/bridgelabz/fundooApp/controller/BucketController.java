...
public class BucketController {
	...
	public ResponseEntity<Response> uploadFile(@RequestPart MultipartFile multipartFile, @RequestHeader String token) throws IOException {
		String url=amazonService.uploadFile(multipartFile, token);
		Response response=new Response(HttpStatus.OK.value(), "uploaded file successfully..", url);
